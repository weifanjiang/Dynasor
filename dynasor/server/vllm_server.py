...
from dynasor.server.entropy import (
    obtain_answer, should_early_exit, uncertain_words, is_certain_answer
)
...
async def handle_adaptive_compute(request: CompletionRequest, raw_request: Request):
    ...
    while remaining_tokens > 0:
        ...
        if should_early_exit(answers, output_text, uncertain_words, certainty_window, is_certains):
